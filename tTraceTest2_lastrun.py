...
expName = 'tTraceTest2'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\tTraceTest2\\tTraceTest2_lastrun.py',
...
for thisTrialsLoop in trialsLoop:
    ...
    trialComponents = [trialMouse, trialCursor, trialTarget1, trialTarget2, trialTarget3, trialTargetA, trialTargetB, trialTargetC, trialText1, trialText2, trialText3, trialTextA, trialTextB, trialTextC]
    ...
    trialsLoop.addData('trialTarget1.started', trialTarget1.tStartRefresh)
    trialsLoop.addData('trialTarget1.stopped', trialTarget1.tStopRefresh)
    trialsLoop.addData('trialTarget2.started', trialTarget2.tStartRefresh)
    trialsLoop.addData('trialTarget2.stopped', trialTarget2.tStopRefresh)
    trialsLoop.addData('trialTarget3.started', trialTarget3.tStartRefresh)
    trialsLoop.addData('trialTarget3.stopped', trialTarget3.tStopRefresh)
    trialsLoop.addData('trialTargetA.started', trialTargetA.tStartRefresh)
    trialsLoop.addData('trialTargetA.stopped', trialTargetA.tStopRefresh)
    trialsLoop.addData('trialTargetB.started', trialTargetB.tStartRefresh)
    trialsLoop.addData('trialTargetB.stopped', trialTargetB.tStopRefresh)
    trialsLoop.addData('trialTargetC.started', trialTargetC.tStartRefresh)
    trialsLoop.addData('trialTargetC.stopped', trialTargetC.tStopRefresh)
    trialsLoop.addData('trialText1.started', trialText1.tStartRefresh)
    trialsLoop.addData('trialText1.stopped', trialText1.tStopRefresh)
    trialsLoop.addData('trialText2.started', trialText2.tStartRefresh)
    trialsLoop.addData('trialText2.stopped', trialText2.tStopRefresh)
    trialsLoop.addData('trialText3.started', trialText3.tStartRefresh)
    trialsLoop.addData('trialText3.stopped', trialText3.tStopRefresh)
    trialsLoop.addData('trialTextA.started', trialTextA.tStartRefresh)
    trialsLoop.addData('trialTextA.stopped', trialTextA.tStopRefresh)
    trialsLoop.addData('trialTextB.started', trialTextB.tStartRefresh)
    trialsLoop.addData('trialTextB.stopped', trialTextB.tStopRefresh)
    trialsLoop.addData('trialTextC.started', trialTextC.tStartRefresh)
    trialsLoop.addData('trialTextC.stopped', trialTextC.tStopRefresh)
